...
class ThreadRanker(object):
    ...
    def get_best_thread(self, question, tag_name):
        ...
        best_thread = pairwise_distances_argmin(question_vec.reshape(1, self.embeddings_dim),
                                                thread_embeddings,
                                                metric='cosine')
...
class DialogueManager(object):
    ...
    def create_chitchat_bot(self):
        ...
        self.chitchat_bot = ChatBot('Sofa', trainer='chatterbot.trainers.ChatterBotCorpusTrainer')
